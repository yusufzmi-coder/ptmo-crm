  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "absolute -top-3 z-10 flex h-10 items-center gap-0.5 rounded-full border border-border bg-popover/95 px-1 shadow-md backdrop-blur-sm transition-opacity lg:h-7",
      ...
      >
        <Popover open={pickerOpen} onOpenChange={setPickerOpen}>
          <PopoverTrigger
            className="flex h-8 w-8 items-center justify-center rounded-full text-popover-foreground hover:bg-muted hover:text-foreground lg:h-5 lg:w-5"
            aria-label={t("react")}
          >
          ...
          >
            {QUICK_EMOJIS.map((e) => (
              <button
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full text-lg leading-none transition-transform hover:scale-125 hover:bg-muted lg:h-8 lg:w-8"
