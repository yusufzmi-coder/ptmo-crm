      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="border-t border-border/50 bg-popover/80 p-4">
            ...
            {deal &&
              (confirmDelete ? (
                <div className="mt-3 flex items-center justify-between gap-2 rounded-md border border-destructive/70 bg-destructive/10 px-3 py-2 text-xs">
                ...
                <button
                  ...
                  className="mt-3 flex w-full items-center justify-center gap-1 text-xs text-destructive hover:text-destructive"
                >
