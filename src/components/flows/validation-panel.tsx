...
export function ValidationPanel() {
  ...
  if (issues.length === 0) {
    ...
    return (
      <div className="flex items-center gap-2 rounded-lg border border-success/70 bg-background p-3 text-sm font-medium text-success">
  ...
  return (
    <div
      className={cn(
        ...
        errors.length > 0 ? "border-destructive/70" : "border-warning/70",
      )}
    >
